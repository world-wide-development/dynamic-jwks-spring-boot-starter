...
public final class VaultJwksCertificateConstants {

    public static final CertificateBundle FIRST_CERTIFICATE_BUNDLE = CertificateBundle.of(
    ...
    private VaultJwksCertificateConstants() {
