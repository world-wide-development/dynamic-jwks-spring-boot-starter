...
@SpringBootTest(
        properties = {
                "dynamic-jwks.pki-certificate-ttl=0s"
        },
        classes = {
                JWKSource.class,
                ...
                VaultDynamicJwkSetRetryIntegrationTest.class
        }
)
@Import({VaultJwkSetIntegrationTestConfiguration.class})
class VaultDynamicJwkSetRetryIntegrationTest extends BaseIntegrationTest {
